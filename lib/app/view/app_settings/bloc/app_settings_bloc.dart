...
class AppSettingsBloc extends Bloc<AppSettingsEvent, AppSettingsState> {
  ...
  AppSettingsBloc({
    ...
    on<SelectLanguage>((event, emit) async {
      ...
      Map<String, int> cache = {"language": event.language!.index};
      await CacheManager<Map<String, int>>().writeData(
        key: CacheManagerEnum.language.name,
        value: cache,
      );
    });
    on<SelectTheme>((event, emit) async {
      ...
      Map<String, int> cache = {"theme": event.appTheme!.index};
      await CacheManager<Map<String, int>>().writeData(
